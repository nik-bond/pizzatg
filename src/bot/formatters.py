...
def format_help() -> str:
    ...
    return (
        ...
        "   💡 Первый указанный пользователь - плательщик\n\n"
        ...
        "   /owed - кто мне должен (с взаимозачётом)\n"
        "   💡 Показывает только тех, кто должен вам после взаимозачёта\n\n\n"
        "🗑️ Удаление:\n"
        "   /delete - удалить последний заказ\n"
        "   💡 Удаляет ваш последний созданный заказ и связанные долги\n\n\n"
        "ℹ️ Другое:\n"
        "   /start - начало работы\n"
        "   /help - эта справка"
    )
